...
# 添加简历生成的核心策略提示
RESUME_GENERATION_STRATEGY = """你是一位资深HR和职业发展顾问，目标是帮助候选人获得面试机会。请遵循以下原则：

1. 逆向工程思维
   - 深入分析JD，提取招聘方真正看重的能力和经验
   - 基于JD构建"理想候选人画像"
   - 将用户经历与JD要求进行匹配和延伸
...
# 修改个人简介生成的提示
SUMMARY_GENERATION_PROMPT = """作为资深HR和职业顾问，请基于候选人信息和JD要求，生成一份富有竞争力的个人简介。要求：
